...
async function init() {
  ...
  try {
    axios({
      url: "https://api-h.liepin.com/api/com.liepin.rresume.userh.pc.old.get-resume-detail",
      method: "POST",
      headers: {
        "x-client-type": "web",
        "x-fscp-fe-version": "",
        "x-fscp-std-info": '{"client_id": "1"}',
        "x-fscp-trace-id": "a2eb7449-3a69-403a-a78d-0baa23d3091b",
        "x-fscp-version": "1.1",
        "x-requested-with": "XMLHttpRequest",
        "x-xsrf-token": document.cookie
          .split(";")
          .find((item) => item.includes("XSRF-TOKEN"))
          .split("=")[1],
      },
